...
export const Dashboard = () => {
    ...
    return (
        <div className="flex flex-col items-center text-gray-300 bg-[#191919] ">
            <div className="flex flex-col items-center gap-10 mb-10 w-full max-w-7xl px-6">
                ...
                <div className="flex flex-col md:flex-row gap-12 items-center">
                    <div className="flex flex-col text-gray-300 gap-6 flex-1">
                        ...
                        <div className="flex gap-6">
                            <button className="flex items-center justify-center gap-2 bg-amber-400 text-gray-900 font-semibold px-6 py-3 rounded-xl hover:bg-amber-400/80 shadow-lg transition duration-300">
                                Solicitar Orçamento
                                <ArrowRight size={18} />
                            </button>
                            <button className="flex bg-[#202020] px-6 py-3 rounded-xl font-semibold border border-gray-700 hover:border-amber-400 transition">
                                Ver Portfólio
                            </button>
                        </div>
                    </div>
                    <div className="flex flex-col w-full md:w-1/3 gap-4">
                        {optionServices.map((service, index) => (
                            <div
                                key={index}
                                className="flex items-center bg-[#202020] gap-4 p-4 rounded-xl hover:bg-[#2a2a2a] transition-all duration-200 ">
